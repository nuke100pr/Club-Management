...
//   const activeFiltersCount = (selectedBoard ? 1 : 0) + (filterType !== "all" ? 1 : 0);
...
//                       }}
//                     >
//                       {type === "all" ? "All Clubs" : type === "myClubs" ? "My Followed Clubs" : "My Followed Boards"}
//                     </Typography>
//                   }
//                   sx={{
//                     mb: 1.5,
...
//                     bgcolor: filterType === type ? 'rgba(95, 150, 230, 0.08)' : 'transparent',
//                     '&:hover': {
...
//                   borderRadius: '8px',
//                   transition: 'all 0.2s ease',
//                   bgcolor: !selectedBoard ? 'rgba(95, 150, 230, 0.08)' : 'transparent',
//                   '&:hover': {
//                     bgcolor: 'rgba(95, 150, 230, 0.05)',
//                   },
//                 }}
...
//                     borderRadius: '8px',
//                     transition: 'all 0.2s ease',
//                     bgcolor: selectedBoard === id ? 'rgba(95, 150, 230, 0.08)' : 'transparent',
//                     '&:hover': {
//                       bgcolor: 'rgba(95, 150, 230, 0.05)',
//                     },
//                   }}
...
//           {filterType !== "all" && (
//             <Chip
//               label={`Show: ${filterType === "myClubs" ? "My Followed Clubs" : "My Followed Boards"}`}
//               size="small"
//               onDelete={() => {
//                 onFilterTypeChange("all");
              ...
              <FormControlLabel
                ...
                label={
                  <Typography
                    variant="body2"
                    sx={{
                      color: !selectedBoard ? "text.primary" : "text.secondary",
                      fontWeight: !selectedBoard ? 500 : 400,
                    }}
                  >
                    All Boards
