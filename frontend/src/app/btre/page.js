  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
              ...
              {badges.length > 0 ? (
                badges.map((badge) => (
                  <TableRow key={badge._id}>
                    ...
                    <TableCell>
                      <IconButton onClick={() => handleOpenBadgeDialog(badge)}>
                        <EditIcon />
                      </IconButton>
                      <IconButton onClick={() => deleteBadge(badge._id)}>
                        <DeleteIcon />
                      </IconButton>
                    </TableCell>
                  </TableRow>
          ...
          {badgeTypes.length > 0 ? (
            ...
            <Grid item xs={12}>
              <Paper sx={{ p: 2, textAlign: "center" }}>
                <Typography>No badge types found</Typography>
              </Paper>
            </Grid>
          )}
        </Grid>
      ...
      >
        ...
        <DialogActions>
          <Button onClick={() => setOpenBadgeDialog(false)}>Cancel</Button>
          <Button
      ...
      >
        ...
        <DialogActions>
          <Button onClick={() => setOpenBadgeTypeDialog(false)}>Cancel</Button>
          <Button
